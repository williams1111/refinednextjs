...
class Server {
    ...
    generateRoutes() {
        ...
        return {
            ...
            locales: ((ref5 = this.nextConfig.i18n) === null || ref5 === void 0 ? void 0 : ref5.locales) || []
        };
    }
   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isServerComponent = !!((ref6 = components.ComponentMod) === null || ref6 === void 0 ? void 0 : ref6.__next_rsc__);
        ...
        if (!!query.__nextDataReq) {
            ...
            if (!(isSSG || hasServerProps) && (!res.statusCode || res.statusCode === 200 || res.statusCode === 404)) {
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref10 = components.Document) === null || ref10 === void 0 ? void 0 : ref10.getInitialProps) !== 'function' || // When concurrent features is enabled, the built-in `Document`
        ...
        const defaultLocale = isSSG ? (ref7 = this.nextConfig.i18n) === null || ref7 === void 0 ? void 0 : ref7.defaultLocale : query.__nextDefaultLocale;
        const locale = query.__nextLocale;
        const locales = (ref8 = this.nextConfig.i18n) === null || ref8 === void 0 ? void 0 : ref8.locales;
        let previewData;
        ...
        resolvedUrlPathname = (0, _normalizeLocalePath).normalizeLocalePath((0, _removeTrailingSlash).removeTrailingSlash(resolvedUrlPathname), (ref9 = this.nextConfig.i18n) === null || ref9 === void 0 ? void 0 : ref9.locales).pathname;
