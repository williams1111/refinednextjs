        ...
        return new Promise((resolve, reject)=>{
           ...
           */ if (/[\\\\/]_middleware$/.test(pageName)) {
                ...
                this.middleware = (0, _utils2).getSortedRoutes(routedMiddleware).map((page)=>{
                    return {
                        match: (0, _routeMatcher).getRouteMatcher(page === '/' && middlewareMatcher ? {
        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame === null || frame === void 0 ? void 0 : frame.file)) {
                    ...
                    const compilation = stats === 'server' ? (ref = this.hotReloader) === null || ref === void 0 ? void 0 : (ref7 = ref.serverStats) === null || ref7 === void 0 ? void 0 : ref7.compilation : (ref8 = this.hotReloader) === null || ref8 === void 0 ? void 0 : (ref9 = ref8.edgeServerStats) === null || ref9 === void 0 ? void 0 : ref9.compilation;
                    const moduleId = frame.file.replace(/^(webpack-internal:\/\/\/|file:\/\/)/, '');
                    const source = await (0, _middleware).getSourceById(!!((ref10 = frame.file) === null || ref10 === void 0 ? void 0 : ref10.startsWith(_path.sep)) || !!((ref11 = frame.file) === null || ref11 === void 0 ? void 0 : ref11.startsWith('file:')), moduleId, compilation);
